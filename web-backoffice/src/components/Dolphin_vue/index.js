...
import DolColBoolean from './list/Dol-col-boolean.vue'
import DolDict from './dict/Dol-dict.vue'
import DolSelect from './select/Dol-select.vue'
import DolTreeSelect from './treeSelect/Dol-tree-select.vue'
...
import DolMap from './bMap/Dol-map.vue'
import DolLocation from './bMap/Dol-location.vue'
...
export default {
  install(Vue){
    ...
    Vue.component('dol-col-boolean',DolColBoolean);
    Vue.component('dol-select',DolSelect);
    Vue.component('dol-tree-select',DolTreeSelect);
    ...
    Vue.component('dol-map',DolMap);
    Vue.component('dol-location',DolLocation);
